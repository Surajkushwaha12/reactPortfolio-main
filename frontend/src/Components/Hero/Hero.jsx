  ...
  return (
    <div className=" p-2  backdrop-blur-2xl text-white  grid gap-2 sm:grid-cols-12 sm:w-[90%] m-auto my-2">
      <div className=" sm:col-span-4">
        <div className={`bg-[#8c63af]  rounded-md sm:col-span-4 p-2 pl-4 mb-2`}>
          <h1 className="font-semibold text-2xl pb-2 border-b text-amber-200">
            About me :)
          </h1>
          <p className="pt-3">Hi there, Welcome to My Space.</p>
          <p>I am <b>Suraj Kushwaha</b>
          , A Full Stack Engineer specialize in crafting dynamic, immersive cross-platform web applications
             with a focus on building sleek and responsive user interfaces. 
          </p>
        </div>
        <div className={`${bgDark} rounded-md sm:col-span-4 p-2 mb-2`}>
          <h1 className="text-2xl font-semibold pb-2 border-b ">
            My Tech Stacks
          </h1>
          ...
          <div className=" sm:col-span-4 ">
            <div className="grid grid-cols-2 gap-2 ">
              <div className={`${bgDark} col-span-1 p-2   rounded-md text-center`}>
                <h2 className="text-l font-semibold pb-2 ">
                  Years of Experience
                </h2>
                <hr  />
              ...
              <div className={`${bgDark} col-span-1 p-2  rounded-md text-center`}>
                ...
                <hr />
                <Link
                  to="https://drive.google.com/file/d/1-iO0kwkkbY2_kjuTSWP5QzW5b9oXmwZd/view?usp=sharing"
